...
Android Studio est un environnement de développement intégré (IDE : Integrated Development Environment) spécialement conçu pour développer des applications natives pour Android.
...
Pour l'installer, rendez-vous sur [https://developer.android.com/](https://developer.android.com/) puis téléchargez la version qui correspond à votre système d'exploitation.


### 2.2 Installation de Kotlin

Si vous travaillez avec l'environnement de développement intrégré (IDE) IntelliJ ou Android Studio, vous n'avez pas besoin d'installer Kotlin. Tout ce qui est nécessaire a été installé avec l'IDE.
...
Android est un système d'exploitation pour appareils mobiles basé sur Linux et développé par le Open Handset Alliance.
...
| 1.1 | Petit Four | 2 | février 2009 | |
| 1.5 | Cupcake | 3 | avril 2009 | |
| 1.6 | Donut | 4 | septembre 2009 | |
| 2.0 | Eclair | 5-6-7 | octobre 2009 | |
| 2.2 | Froyo | 8 | mai 2010 | |
| 2.3 | Gingerbread | 9-10 | décembre 2010 | |
| 3.0 | Honeycomb | 11-12-13 | février 2011 | |
| 4.0 | Ice Cream Sandwich | 14-15 | octobre 2011 | |
| 4.1 | Jelly Bean | 16-17-18 | juillet 2012 | |
| 4.4 | KitKat | (à l'interne : Key Lime Pie) | 19-20 | octobre 2013 |
| Lollipop | | 21-22 | novembre 2014 | |
| 5.0 | (à l'interne : Lemon Meringue Pie) | | septembre 2015 | |
| Marshmallow | (à l'interne : Macadamia Nut Cookie) | 23 | août 2016 | |
| 6.0 | Oreo | (à l'interne : Oatmeal Cookie) | 24-25 | août 2017 |
| 7.0 | Nougat | (à l'interne : New York Cheesecake) | 26-27 | août 2018 |
| 8.0 | Pie | (à l'interne : Pistachio Ice Cream) | 28 | septembre 2019 |
| 9.0 | Quince Tart | (nom utilisé à l'interne) | 30 | octobre 2021 |
| 10 | Red Velvet Cake | (nom utilisé à l'interne) | 31-32 | août 2022 |
...
Lorsqu'on débute le développement d'une application à l'aide d'une nouvelle technologie, il est important de se baser sur les meilleures pratiques et d'utiliser des outils récents.

Avant d'écrire la première version de cette formation à l'automne 2023, j'ai pris le temps de bien explorer les technologies existantes afin de choisir celles qui me semblaient le plus à jour pour développer une application mobile Android.
...
#### Application hybride (basé sur HTML, CSS et JavaScript) à l'aide d'un cadre d'application (framework) tel que Cordova ou PhoneGab
...
Il est à noter que les développeurs d'Android donnent l'avantage à Android Studio pour certaines fonctionnalités récentes, qui ne seront disponibles dans IntelliJ que plus tard.
